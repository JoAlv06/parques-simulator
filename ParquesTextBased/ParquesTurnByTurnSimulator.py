...
104: Yellow Jail
 ...
 The following four classes are the four different colors of pieces used in this simulation of parques.
    ...
    color is the "color" or player that the piece belongs to
'''
class redPiece:
    def __init__(self):
       self.index = 0
...
def stomp(piece,other1,other2,other3,other4,other5,other6,other7,other8,other9,other10,other11,other12):
    ...
    for i in otherpieces:
        if i.track[i.index] == start:
            i.index = 0
            print(str(i.color) + " piece stomped")
...
def mainMove(piece1,piece2,piece3,piece4,other1,other2,other3,other4,other5,other6,other7,other8,other9,other10,other11,other12):
    ...
    print("\n" + piece1.color + "1: " + str(piece1.index) + " | " + piece2.color + "2: " + str(piece2.index) + " | " + piece3.color + "3: " + str(piece3.index) + " | " + piece4.color + "4: " + str(piece4.index))
    #Strat 1
...
#Creating four pieces of each color
red1 = redPiece()
red2 = redPiece()
red3 = redPiece()
red4 = redPiece()
...
#Choosing the turn order of the game randomly
#Then starts the text-based version of the simulation, goes turn by turn.
rando = random.randint(1,4)
if rando == 1:
    print("Order RGBY")
    while (red1.index < 72 or red2.index < 72 or red3.index < 72 or red4.index < 72) and (green1.index < 72 or green2.index < 72 or green3.index < 72 or green4.index < 72) and (blue1.index < 72 or blue2.index < 72 or blue3.index < 72 or blue4.index < 72) and (yellow1.index < 72 or yellow2.index < 72 or yellow3.index < 72 or yellow4.index < 72):
        ...
        print('\nred1: ' + str(red1.index) + ' | red2: ' + str(red2.index) + ' | red3: ' + str(red3.index) + ' | red4: ' + str(red4.index))
        print('green1: ' + str(green1.index) + ' | green2: ' + str(green2.index) + ' | green3: ' + str(green3.index) + ' | green4: ' + str(green4.index))
        print('blue1: ' + str(blue1.index) + ' | blue2:' + str(blue2.index) + ' | blue3: ' + str(blue3.index) + ' | blue4: ' + str(blue4.index))
        print('yellow1: ' + str(yellow1.index) + ' | yellow2: ' + str(yellow2.index) + ' | yellow3: ' + str(yellow3.index) + ' | yellow4: ' + str(yellow4.index))
        print("\n-------------------------------------------------------------------------------\n")
        w = input()    
elif rando == 2:
    print("Order GBYR")
    while (red1.index < 72 or red2.index < 72 or red3.index < 72 or red4.index < 72) and (green1.index < 72 or green2.index < 72 or green3.index < 72 or green4.index < 72) and (blue1.index < 72 or blue2.index < 72 or blue3.index < 72 or blue4.index < 72) and (yellow1.index < 72 or yellow2.index < 72 or yellow3.index < 72 or yellow4.index < 72):
        ...
        print('\ngreen1: ' + str(green1.index) + ' | green2: ' + str(green2.index) + ' | green3: ' + str(green3.index) + ' | green4: ' + str(green4.index))
        print('blue1: ' + str(blue1.index) + ' | blue2:' + str(blue2.index) + ' | blue3: ' + str(blue3.index) + ' | blue4: ' + str(blue4.index))
        print('yellow1: ' + str(yellow1.index) + ' | yellow2: ' + str(yellow2.index) + ' | yellow3: ' + str(yellow3.index) + ' | yellow4: ' + str(yellow4.index))
        print('red1: ' + str(red1.index) + ' | red2: ' + str(red2.index) + ' | red3: ' + str(red3.index) + ' | red4: ' + str(red4.index))
        print("\n-------------------------------------------------------------------------------\n")
        w = input()    
    ...
    while (red1.index < 72 or red2.index < 72 or red3.index < 72 or red4.index < 72) and (green1.index < 72 or green2.index < 72 or green3.index < 72 or green4.index < 72) and (blue1.index < 72 or blue2.index < 72 or blue3.index < 72 or blue4.index < 72) and (yellow1.index < 72 or yellow2.index < 72 or yellow3.index < 72 or yellow4.index < 72):
        ...
        print('\nblue1: ' + str(blue1.index) + ' | blue2:' + str(blue2.index) + ' | blue3: ' + str(blue3.index) + ' | blue4: ' + str(blue4.index))
        print('yellow1: ' + str(yellow1.index) + ' | yellow2: ' + str(yellow2.index) + ' | yellow3: ' + str(yellow3.index) + ' | yellow4: ' + str(yellow4.index))
        print('red1: ' + str(red1.index) + ' | red2: ' + str(red2.index) + ' | red3: ' + str(red3.index) + ' | red4: ' + str(red4.index))
        print('green1: ' + str(green1.index) + ' | green2: ' + str(green2.index) + ' | green3: ' + str(green3.index) + ' | green4: ' + str(green4.index))
        print("\n-------------------------------------------------------------------------------\n")
